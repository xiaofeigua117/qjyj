			...
			case 1:
				...
				if (data.charAt(4) == '3') {
					...
					Toast.makeText(MainActivity.this,
							shiwaiwendu + "" + shiwaishidu, 2000).show();
		...
		group_main.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup group, int checkedID) {
				...
				case R.id.rb_main_menu1:
					...
					//
					// transaction.replace(R.id.Fragment_jiemian,new
					// Fragmnet_main());
				...
				case R.id.rb_main_menu2:
					...
					// thisfragment,
					// //and add the transaction to the backstack
					// transaction2.replace(R.id.Fragment_jiemian,new
					// Fragment_Fan());
					//
					// transaction2.commit();
				...
				case R.id.rb_main_menu3:
					switchContent(getVisibleFragment(),
							new Fragment_heatExchange());
					// FragmentTransaction
					// transaction2=getSupportFragmentManager().beginTransaction();
					// //Replace whatever is in the fragment_container view with
					// thisfragment,
				...
				case R.id.rb_main_menu4:
					switchContent(getVisibleFragment(),
							new Fragment_newdetail());
					// FragmentTransaction
					// transaction3=getSupportFragmentManager().beginTransaction();
					// //Replace whatever is in the fragment_container view with
					// thisfragment,
					// //and add the transaction to the backstack
					// transaction3.replace(R.id.Fragment_jiemian,new
					// Fragment_details());
					// transaction3.commit();
					break;
				case R.id.rb_main_menu5:
					...
					// //and add the transaction to the backstack
					//
					// transaction4.replace(R.id.Fragment_jiemian,new
					// Fragment_Settings());
					//
					// transaction4.commit();
					break;
				case R.id.rb_main_menu6:
					...
					// FragmentTransaction
					// transaction5=getSupportFragmentManager().beginTransaction();
					// //Replace whatever is in the fragment_container view with
					// thisfragment,
					// //and add the transaction to the backstack
					//
					// transaction5.replace(R.id.Fragment_jiemian,new
					// Fragment_aoubtus());
					//
					// transaction5.commit();
					break;

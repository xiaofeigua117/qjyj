...
//	private SerialPort serialPort;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		textView_fan_main.setOnClickListener(new OnClickListener() {
			...
			textView_fan_washroom.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					textView_fan_washroom.setBackgroundResource(R.drawable.fan_inner2);
		...
		new ReceiveThread().start();
			//serialPort = new SerialPort(mTag, mBackStackNesting, mBackStackNesting, mBackStackNesting, mBackStackNesting);
		switch_fengji1.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton arg0, boolean checked) {
				// TODO Auto-generated method stub
			if(checked){
				// byte[] sbuf = CRC16M.getSendBuf(editText_fa.getText().toString());  

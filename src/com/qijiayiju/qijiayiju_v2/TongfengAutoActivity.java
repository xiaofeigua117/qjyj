			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
		           PendingIntent sender = PendingIntent.getBroadcast(  
		             TongfengAutoActivity.this,0, new Intent(TongfengAutoActivity.this,MyReceiver.class), 0);  
		           AlarmManager am;  
...
buttond.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
		           PendingIntent sender = PendingIntent.getBroadcast(  
		             TongfengAutoActivity.this,1, new Intent(TongfengAutoActivity.this,MyReceiver.class), 0);  
		           AlarmManager am;  
		           am = (AlarmManager)getSystemService(ALARM_SERVICE);  
		           am.cancel(sender);  
		          Toast.makeText(TongfengAutoActivity.this,"闹钟时间删除",  
...
private void setReminder(boolean b,int hour,int min,Boolean b1,Boolean b2,String time) {
...
//        	 futureDate.setSeconds(0);
   ...
   public void EditClick(View v){
	   switch (v.getId()) {
	case R.id.editText1:
		new AlertDialog.Builder(context).setPositiveButton("确定", null).setSingleChoiceItems(new String[]{"30分钟","50分钟","60分钟"}, 0, new DialogInterface.OnClickListener() {
...
public void showmyDialog(int i){
	...
	TimePickerDialog pickerDialog=new TimePickerDialog(this, onTimeSetListener, hour, min, true);
	pickerDialog.show();

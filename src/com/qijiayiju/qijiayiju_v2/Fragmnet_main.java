...
public class Fragmnet_main extends Fragment {
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case UPDATE:
				...
				jishu = jishu + 1;
				if (jishu == 5) {
					// MySeriailPort.getSeriail().sendData("0103000b000435cb",
					// "HEX");
					MySeriailPort.getSeriail().sendData("0103000b000835ce",
							"HEX");
					// 000b0008 35ce
					// MySeriailPort.getSeriail().sendData("0103000c00014409",
					// "HEX");
					// MySeriailPort.getSeriail().sendData("0103000d000115c9",
					// "HEX");
					textView_shiwen.setText((float) (Math
							.round(MainActivity.shiwen * 10)) / 10 + "℃");
					textView_shineishidu
							.setText((float) (Math
									.round(MainActivity.shineishidu * 10))
									/ 10
									+ "Rh%");
					textView_shiwai.setText((float) ((Math
							.round(MainActivity.shiwaiwendu) * 10)) / 10 + "℃");
					textView_shiwaishidu
							.setText((float) (Math
									.round(MainActivity.shiwaishidu * 10))
									/ 10
									+ "Rh%");
					textView_co2.setText((float) (Math
							.round(MainActivity.shineico2)) + "ppm");
					textView_woshiwendu.setText((float) (Math
							.round(MainActivity.woshiwendu1 * 10)) / 10 + "℃");
					textView_woshishidu
							.setText((float) (Math
									.round(MainActivity.woshishidu1 * 10))
									/ 10
									+ "Rh%");
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		textView_shiwaishidu = (TextView) view
				.findViewById(R.id.show_shiwaishidu);

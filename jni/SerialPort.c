...
#include "com_dwin_navy_serialportapi_SerialPortJNI.h"
...
/*
 * Class:     com_dwin_navy_serialclass_SerialPortJNI
 * Method:    setSpeed
 * Signature: (II)I
...
JNIEXPORT jobject JNICALL Java_com_dwin_navy_serialportapi_SerialPortJNI_open485Dev(
		JNIEnv *env, jobject thiz, jstring devnum) {
	return Java_com_dwin_navy_serialportapi_SerialPortJNI_openDev(env, thiz,
			devnum);
}
...
JNIEXPORT jint JNICALL Java_com_dwin_navy_serialportapi_SerialPortJNI_close485Dev(
		JNIEnv *env, jobject thiz, jobject mfd) {
	return Java_com_dwin_navy_serialportapi_SerialPortJNI_closeDev(env, thiz,
			mfd);
}
